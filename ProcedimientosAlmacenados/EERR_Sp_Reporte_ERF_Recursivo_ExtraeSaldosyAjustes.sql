...
IF OBJECT_ID ( '[EERR_Sp_Reporte_ERF_Recursivo_ExtraeSaldosyAjustes]', 'P' ) IS NOT NULL 
    DROP PROCEDURE EERR_Sp_Reporte_ERF_Recursivo_ExtraeSaldosyAjustes;
GO

CREATE PROCEDURE EERR_Sp_Reporte_ERF_Recursivo_ExtraeSaldosyAjustes
...
BEGIN
	SET NOCOUNT ON;
	--
	Set @sName = 'EERR_Sp_Reporte_ERF_Recursivo_ExtraeSaldosyAjustes';
				...
				Begin
					...
					If @iTipoNodo = 1
						Begin
							...
							Execute @iRetVal = EERR_Sp_Reporte_ERF_Recursivo_ExtraeSaldosyAjustes @sToken, @iIdAnidado, @sPeriodo, @sLibros, @sDeepP;
							If @iRetVal = 1 
								Begin
