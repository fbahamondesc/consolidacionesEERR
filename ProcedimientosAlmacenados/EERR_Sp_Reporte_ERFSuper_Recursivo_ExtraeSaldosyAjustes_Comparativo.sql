...
IF OBJECT_ID ( '[EERR_Sp_Reporte_ERFSuper_Recursivo_ExtraeSaldosyAjustes_Comparativo]', 'P' ) IS NOT NULL 
    DROP PROCEDURE EERR_Sp_Reporte_ERFSuper_Recursivo_ExtraeSaldosyAjustes_Comparativo;
GO

CREATE PROCEDURE EERR_Sp_Reporte_ERFSuper_Recursivo_ExtraeSaldosyAjustes_Comparativo
...
BEGIN
	SET NOCOUNT ON;
	--
	Set @sName = 'EERR_Sp_Reporte_ERFSuper_Recursivo_ExtraeSaldosyAjustes_Comparativo';
	Set @sDeepP = @sDeep +'__';
	--
				...
				Begin
					...
					If @iTipoNodo = 1
						Begin
							...
							Execute @iRetVal = EERR_Sp_Reporte_ERFSuper_Recursivo_ExtraeSaldosyAjustes_Comparativo @sToken, @iIdAnidado, @sPeriodo, @sPeriodoO, @sLibros, @sDeepP;
							If @iRetVal = 1 
								Begin
