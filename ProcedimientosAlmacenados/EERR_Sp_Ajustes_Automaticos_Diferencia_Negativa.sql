...
IF OBJECT_ID ( 'EERR_Sp_Ajustes_Automaticos_Diferencia_Negativa', 'P' ) IS NOT NULL 
    DROP PROCEDURE EERR_Sp_Ajustes_Automaticos_Diferencia_Negativa;
GO

CREATE PROCEDURE EERR_Sp_Ajustes_Automaticos_Diferencia_Negativa
...
BEGIN
	Set @sName = 'EERR_Sp_Ajustes_Automaticos_Diferencia_Negativa'; 

	Begin Try
		Set @iDiferencia = @iDiferencia * (-1);
		...
		If @sCuentaOrigen = 0
			Begin
				...
				--	@iIdConsolidado, @iAsiento, @sContraCuenta, @sPeriodoAfecta, @sPeriodoAfecta, @iTipo, @iDiferencia, 0, @sGlosa;
				Execute @iRetVal = EERR_Sp_Ajustes_Automaticos_Inserta_Linea
					@iIdConsolidado, @iAsiento, @sContraCuenta, @sPeriodoAfecta, @sPeriodoAfecta, @iTipo, @nCuadra, 0, @sGlosa;
			End;
		Else
			Begin
				-- Insertar Ajuste Cuenta Destino
				Execute @iRetVal = EERR_Sp_Ajustes_Automaticos_Inserta_Linea
					@iIdConsolidado, @iAsiento, @sCuentaAjuste, @sPeriodoAfecta, @sPeriodoAfecta, @iTipo, 0, @iDiferencia, @sGlosa;
			End;
		If @iRetVal = 1
			Begin
			...
			Begin
				If @sCuentaOrigen = 0
					Begin
						...
						Execute @iRetVal = EERR_Sp_Ajustes_Automaticos_Inserta_Linea
							@iIdConsolidado, @iAsiento, @sCuentaDestinoNC, @sPeriodoAfecta, @sPeriodoAfecta, @iTipo, @nResto, 0, @sGlosa;
					End;
				Else
					Begin
