...
IF OBJECT_ID ( '[EERR_Sp_Reporte_ERF_ExtraeAjustes]', 'P' ) IS NOT NULL 
    DROP PROCEDURE EERR_Sp_Reporte_ERF_ExtraeAjustes;
GO

CREATE PROCEDURE EERR_Sp_Reporte_ERF_ExtraeAjustes
...
BEGIN
	SET NOCOUNT ON;
	--
	Set @sName = 'EERR_Sp_Reporte_ERF_ExtraeAjustes'; 
	--
