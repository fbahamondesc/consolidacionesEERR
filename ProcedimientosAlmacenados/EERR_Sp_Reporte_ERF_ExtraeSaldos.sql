...
IF OBJECT_ID ( '[EERR_Sp_Reporte_ERF_ExtraeSaldos]', 'P' ) IS NOT NULL 
    DROP PROCEDURE EERR_Sp_Reporte_ERF_ExtraeSaldos;
GO

CREATE PROCEDURE EERR_Sp_Reporte_ERF_ExtraeSaldos
...
BEGIN
	SET NOCOUNT ON;
	--
	Set @sName = 'EERR_Sp_Reporte_ERF_ExtraeSaldos'; 
	--
